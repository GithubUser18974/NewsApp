...
public class NewsAdapter extends ArrayAdapter<NewsData> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        switch (currentNewsData.getType().toLowerCase()){
            case "environment":{imageView.setImageResource(R.drawable.icons_environment);break;}
            case "politics":{imageView.setImageResource(R.drawable.icon_politic);break;}
            case "sport":{imageView.setImageResource(R.drawable.icon_sport);break;}
            case "film":{imageView.setImageResource(R.drawable.icon_film);break;}
            default:imageView.setImageResource(R.drawable.news);
        }
